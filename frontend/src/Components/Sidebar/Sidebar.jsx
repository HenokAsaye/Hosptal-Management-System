      ...
      case "doctor":
        return (
          <ul>
            ...
            <li><Link to="/doctor-notification" className={location.pathname === "/doctor-notification" ? classes.active : ""}><IoNotifications size={24} className="icon" /> Notifications</Link></li>
